...
public class SanPhamService {
    ...
    public List<SanPham> getAllSP() {
        ...
        try {
            ...
            rs = ps.executeQuery();
            while (rs.next()) {
                SanPham pham=new SanPham(rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4),
    ...
    public List<SanPham> findSP(String maSP) {
        sql = "select ct.MaCTSP, sp.MaSP, sp.TenSP,ct.ChatLieu, ct.KichThuoc, ct.Mau, ct.SoLuong,ct.NhaSX, ct.XuatXu,sp.MaDM,sp.DonGia,ct.MoTa,sp.Barcode from SanPham sp\n"
                + "join ChiTietSanPham ct on sp.MaSP= ct.MaSP\n"
                + "where sp.MaSP =?";
