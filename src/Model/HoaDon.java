...
public class HoaDon {
    ...
    public HoaDon(String maHD, String maHDCT, String maKH, String tenKH, String maSP, String tenSP, String donGia, String soLuong, String ghiChu, String ngayTao, String tongTien) {
        this.maHD = maHD;
        this.maHDCT = maHDCT;
        this.maKH = maKH;
        this.tenKH = tenKH;
    ...
    public HoaDon(String maHD, String ngayTao, String tongTien) {
        this.maHD = maHD;
        this.ngayTao = ngayTao;
        this.tongTien = tongTien;
    }
