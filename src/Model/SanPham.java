...
public class SanPham {
    ...
    public SanPham(String maSP, String tenSP, String maDM, String donGia, String maSPCT, String chatLieu, String kichThuoc, String mauSac, String soLuong, String nhaSX, String xuatXu, String moTa,String Barcode) {
        this.maSP = maSP;
        this.tenSP = tenSP;
        this.maDM = maDM;
        this.donGia = donGia;
    ...
    public SanPham(String maSP, String tenSP, String maDM, String maNSX, String donGia, String trangThai,String Barcode) {
        this.maSP = maSP;
        this.tenSP = tenSP;
        this.maDM = maDM;
        this.maNSX = maNSX;
    ...
    public Object[] todataRow(){
        return new Object[]{
            this.maSP,this.tenSP,this.maDM,this.maNSX,this.getDonGia2(),this.getStringTrangThai(),this.getBarcode()
        };
    }
}
