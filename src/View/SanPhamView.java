...
//    public List<SanPham> findGia(List<SanPham> list) {
//        List<SanPham> timGia = new ArrayList<>();
//        if (txtGiaDuoi.getText().trim().equals("0")) {
//            for (SanPham sanPham : list) {
//                if (Integer.parseInt(sanPham.getDonGia2()) <= Integer.parseInt(txtGiaTren.getText().trim())) {
//                    timGia.add(sanPham);
//                }
//            }
//            return timGia;
//        }
//        if (txtGiaTren.getText().trim().equals("0")) {
//            for (SanPham sanPham : list) {
//                if (Integer.parseInt(sanPham.getDonGia2()) >= Integer.parseInt(txtGiaDuoi.getText().trim())) {
//                    timGia.add(sanPham);
//                }
//            }
//            return timGia;
//        }
//        if (!txtGiaDuoi.getText().trim().equals("0") && !txtGiaTren.getText().trim().equals("0")) {
//            for (SanPham sanPham : list) {
//                if (Integer.parseInt(sanPham.getDonGia2()) <= Integer.parseInt(txtGiaTren.getText().trim())
//                        && Integer.parseInt(sanPham.getDonGia2()) >= Integer.parseInt(txtGiaDuoi.getText().trim())) {
//                    timGia.add(sanPham);
//                }
//            }
//            return timGia;
...
//    }
    ...
    private void initComponents() {
        ...
        tblSanPham.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã sản phẩm", "Tên sản phẩm", "Mã danh mục", "Mã nhà sản xuất", "Đơn giá", "Trạng Thái", "Barcode"
            }
        ) {
